...
<img src = "2.png" width = "1100">

[Посилання на дошку FigJam](https://www.figma.com/board/Ff5gUTVhp2bz05xoZWuwoK/Untitled?t=XkUg1Gh4ULlXRODu-0)
...
Для мобільного застосунку використовується 4 або 6-колонкова сітка з 8px відступами між колонками — це стандартний підхід для екранів шириною 360–390px. Я застосував цю сітку у своєму дизайні: картки книг займають рівно 2 колонки кожна, а список результатів пошуку — всі 6. Усі padding'и та відступи між блоками кратні 8px — це дає відчуття «повітря» і полегшує адаптацію під різні розміри екранів у майбутньому. Кнопки суворо вирівняні по межах колонок, що робить передачу макету розробнику однозначною.

[Посилання на проєкт у Figma](https://www.figma.com/design/EcO0px5O7KEoc1alk9zBlV/Wareframes?node-id=0-1&p=f&t=XkUg1Gh4ULlXRODu-0)
...
| :--- | :--- | :--- |
| H1 (Heading) | 20 px | Назва застосунку, заголовки розділів «Продовжити читання» |
